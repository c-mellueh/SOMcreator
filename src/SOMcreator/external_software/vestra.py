...
def create_mapping(excel_path:str,folder_path:str,project):
    ...
    def create_xml(name:str,object:classes.Object):
        ...
        tree.write(os.path.join(folder_path,f"{name.replace('/','_')}.amrx"),pretty_print=True, encoding="utf-8", xml_declaration=True)
